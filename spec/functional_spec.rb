...
EOT
  ...
  describe "new" do
    ...
    it "displays an error message when given multiple file arguments" do
      r, out = ex 'new foo bar baz'
      r.should_not eq 0
      out.should include "Error: Multiple filenames given."      
    end

    it "displays an error message when mixing issue file path and attribute defaults" do
      issues_before = taco.list
      r, out = ex 'new %s kind:KindNumber1' % issue_path
      r.should_not eq 0
      out.should include "Error: Cannot set defaults when creating Issue from file."
    end
...
EOT
      ...
      describe "default values" do
        ...
        it "sets defaults from command line arguments" do
          r, out = ex 'new kind:KindNumber1', :env => { 'EDITOR' => EDITOR_PATH }
          r.should eq 0
          out.should include "Created Issue "
...
EOT
  ...
  describe "argument handling" do
    it "displays an error for wrong number of arguments" do
      ...
      r.should_not eq 0
      out.should include 'Multiple filenames given.'
